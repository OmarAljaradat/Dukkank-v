            ...
            <div className="w-full max-w-md">
                <div className="card-elevated rounded-3xl bg-white border border-[hsl(var(--brand-ink))]/10 overflow-hidden">
                    ...
                    <form onSubmit={onSubmit} className="p-7 space-y-4">
                        ...
                        {import.meta.env.DEV && (
                            <div className="rounded-xl bg-amber-50 border border-amber-200 px-4 py-3 text-xs text-amber-800 text-center space-y-0.5">
                                <div className="font-bold mb-1">بيانات الدخول الافتراضية (بيئة تطوير)</div>
                                <div dir="ltr">admin@dukkank.com</div>
                                <div dir="ltr">admin123</div>
                            </div>
                        )}
                    </form>
                </div>
